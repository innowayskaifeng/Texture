 ...
 * This includes UIScrollViewDelegate as well as most methods from UICollectionViewDelegate, like
 * willDisplay...
 */
 ...
 * the pager node will set the property on the view controller to NO and log a warning message. In
 * the future, the pager node will just log the warning, and you'll need to configure your view
