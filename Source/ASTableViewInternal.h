 ...
 *
 * @param dataControllerClass A controller class injected to and used to create a data controller
 * for the table view.
 *
...
/// Returns the width of the section index view on the right-hand side of the table, if one is
/// present.
