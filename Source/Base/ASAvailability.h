...
#define AS_AT_LEAST_IOS10 \
  (kCFCoreFoundationVersionNumber >= kCFCoreFoundationVersionNumber_iOS_10_0)
#define AS_AT_LEAST_IOS11 \
  (kCFCoreFoundationVersionNumber >= kCFCoreFoundationVersionNumber_iOS_11_0)
...
// NOTE: Yoga integration is experimental and not fully tested. Use with caution and test layouts
// carefully.
