...
/**
 @abstract Use ASPhotosFrameworkImageRequest to encapsulate all the information needed to request an
 image from the Photos framework and store it in a URL.
 */
...
/**
 @abstract The options specified for this request. Default value is the result of
