...
// NOTE: Some properties, like initialContentOffset and layoutCache are ignored in
// -isEqualToContext: and -hash. That is because contexts can be equal regardless of the content
// offsets or layout caches.
...
- (NSUInteger)hash {
  ...
  } data = {_viewportSize, _scrollableDirections, _elements.hash, _layoutDelegateClass.hash,
