 ...
 * It uses a concurrent and multi-line ASStackLayoutSpec under the hood. Thus, per-child flex
 * properties (i.e alignSelf, flexShrink, flexGrow, etc - see @ASStackLayoutElement) can be set
 * directly on cell nodes to be used to calculate the final collection layout.
 */
