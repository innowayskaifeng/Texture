...
/**
 * Asks the inspector for the number of supplementary views for the given kind in the specified
 * section.
 */
...
/**
 * Asks the inspector for the number of supplementary sections in the collection view for the given
 * kind.
 *
...
/**
 * A layout inspector for non-flow layouts that returns a constrained size to let the cells layout
 * itself as far as possible based on the scrollable direction of the collection view. It doesn't
 * support supplementary nodes and therefore doesn't implement delegate methods that are related to
 * supplementary node's management.
 *
