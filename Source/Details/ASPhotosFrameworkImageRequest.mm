...
- (NSURL *)url {
  ...
  NSMutableArray *queryItems = [NSMutableArray
      arrayWithObjects:[NSURLQueryItem queryItemWithName:_ASPhotosURLQueryKeyWidth
                       ...
                       [NSURLQueryItem
                           queryItemWithName:_ASPhotosURLQueryKeyAllowNetworkAccess
  ...
  if (!CGRectIsEmpty(cropRect)) {
    [queryItems addObjectsFromArray:@[
      [NSURLQueryItem queryItemWithName:_ASPhotosURLQueryKeyCropOriginX
                                  value:@(cropRect.origin.x).stringValue],
      [NSURLQueryItem queryItemWithName:_ASPhotosURLQueryKeyCropOriginY
                                  value:@(cropRect.origin.y).stringValue],
      [NSURLQueryItem queryItemWithName:_ASPhotosURLQueryKeyCropWidth
                                  value:@(cropRect.size.width).stringValue],
      [NSURLQueryItem queryItemWithName:_ASPhotosURLQueryKeyCropHeight
                                  value:@(cropRect.size.height).stringValue]
    ]];
  }
...
+ (ASPhotosFrameworkImageRequest *)requestWithURL:(NSURL *)url {
  ...
  ASPhotosFrameworkImageRequest *request =
      [[ASPhotosFrameworkImageRequest alloc] initWithAssetIdentifier:url.host];
