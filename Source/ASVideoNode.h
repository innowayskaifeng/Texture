...
/**
 * @abstract Delegate method invoked when the video is done loading the asset and can start the
 * playback
 * @param videoNode The videoNode
 */
- (void)videoNodeDidFinishInitialLoading:(ASVideoNode *)videoNode;
/**
 * @abstract Delegate method invoked when the AVPlayerItem for the asset has been set up and can be
 * accessed throught currentItem.
 * @param videoNode The videoNode.
