...
NSArray<NSString *> *ASExperimentalFeaturesGetNames(ASExperimentalFeatures flags) {
  NSArray *allNames = ASCreateOnce((@[
    ...
    @"exp_infer_layer_defaults", @"exp_network_image_queue", @"exp_collection_teardown",
    @"exp_framesetter_cache", @"exp_skip_clear_data", @"exp_did_enter_preload_skip_asm_layout",
    @"exp_disable_a11y_cache", @"exp_skip_a11y_wait", @"exp_new_default_cell_layout_mode",
    @"exp_dispatch_apply"
  ]));
