...
/** Lays out a single layoutElement child and positions it within the layout bounds according to
 * vertical and horizontal positional specifiers. Can position the child at any of the 4 corners, or
 * the middle of any of the 4 edges, as well as the center - similar to "9-part" image areas.
 */
@interface ASRelativeLayoutSpec : ASLayoutSpec

// You may create a spec with alloc / init, then set any non-default properties; or use a
// convenience initialize that accepts all properties.
