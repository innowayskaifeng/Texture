...
/** Lays out a single layoutElement child and position it so that it is centered into the layout
 * bounds. NOTE: ASRelativeLayoutSpec offers all of the capabilities of Center, and more. Check it
 * out if you would like to be able to position the child at any corner or the middle of an edge.
 */
