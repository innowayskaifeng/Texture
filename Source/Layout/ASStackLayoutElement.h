...
/**
 * @abstract If the sum of childrens' stack dimensions is less than the minimum size, how much
 * should this component grow? This value represents the "flex grow factor" and determines how much
 * this component should grow in relation to any other flexible children.
 */
@property(nonatomic) CGFloat flexGrow;

/**
 * @abstract If the sum of childrens' stack dimensions is greater than the maximum size, how much
 * should this component shrink? This value represents the "flex shrink factor" and determines how
 * much this component should shink in relation to other flexible children.
 */
...
/**
 *  @abstract Used for baseline alignment. The distance from the baseline of the object to its
 * bottom.
 */
