...
// The maximum number of extended values per type are defined in ASEnvironment.h above the
// ASEnvironmentStateExtensions struct definition. If you try to set a value at an index after the
// maximum it will throw an assertion.
...
#define ASDK_STYLE_PROP_OBJ(PROPERTY_TYPE, PROPERTY_NAME, SETTER_NAME)              \
  ...
  -(void)SETTER_NAME : (PROPERTY_TYPE)PROPERTY_NAME {                               \
    objc_setAssociatedObject(self, @selector(PROPERTY_NAME), PROPERTY_NAME,         \
