...
/**
 * A dummy item that represents a collection element to participate in the collection layout
 * calculation process without triggering measurement on the actual node of the collection element.
 *
...
- (instancetype)initWithItemSize:(CGSize)itemSize
               collectionElement:(ASCollectionElement *)collectionElement;
