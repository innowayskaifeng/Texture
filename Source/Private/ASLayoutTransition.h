...
/**
 * @abstract Returns if the layoutElement can be used to layout in an asynchronous way on a
 * background thread.
 */
...
/**
 * Insert and remove subnodes that were added or removed between the previousLayout and the
 * pendingLayout
 */
- (void)commitTransition;

/**
 * Insert all new subnodes that were added and move the subnodes that moved between the previous
 * layout and the pending layout.
 */
