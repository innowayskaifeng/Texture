 ...
 * -tableView:beginBatchFetchingWithContext: is called.
 *
 ...
 * Initializer.
 *
 * @param frame A rectangle specifying the initial location and size of the table view in its
 * superview’s coordinates. The frame of the table view changes as table cells are added and
 * deleted.
 *
 * @param style A constant that specifies the style of the table view. See UITableViewStyle for
...
/**
 *  Begins a series of method calls that insert, delete, select, or reload rows and sections of the
 * table view, with animation enabled and no completion block.
 *
 *  @discussion You call this method to bracket a series of method calls that ends with endUpdates
 * and that consists of operations to insert, delete, select, and reload rows and sections of the
 * table view. When you call endUpdates, ASTableView begins animating the operations simultaneously.
 * It's important to remember that the ASTableView will be processing the updates asynchronously
...
/**
 *  Concludes a series of method calls that insert, delete, select, or reload rows and sections of
 * the table view, with animation enabled and no completion block.
 *
 *  @discussion You call this method to bracket a series of method calls that begins with
 * beginUpdates and that consists of operations to insert, delete, select, and reload rows and
 * sections of the table view. When you call endUpdates, ASTableView begins animating the operations
 * simultaneously. It's important to remember that the ASTableView will be processing the updates
 * asynchronously after this call is completed.
 *
...
/**
 *  Concludes a series of method calls that insert, delete, select, or reload rows and sections of
 * the table view. You call this method to bracket a series of method calls that begins with
 * beginUpdates and that consists of operations to insert, delete, select, and reload rows and
 * sections of the table view. When you call endUpdates, ASTableView begins animating the operations
 * simultaneously. This method is must be called from the main thread. It's important to remember
 * that the ASTableView will be processing the updates asynchronously after this call and are not
