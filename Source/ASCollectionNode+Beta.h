...
/**
 * The elements that are currently displayed. The "UIKit index space". Must be accessed on main
 * thread.
 */
...
/**
 *  Returns YES if the ASCollectionNode contents are completely synchronized with the underlying
